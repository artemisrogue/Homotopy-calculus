  ...
  function knotsHTML() {
    return '' +
      ...
      '<div class="expo-panel">' +
        ...
        'everything finite-type (in the additive sense made precise in &sect;4 below).</p>' +
      '</div>' +
    ...
    return '' +
      ...
      '<div class="expo-panel">' +
        ...
        '<ul>' +
          ...
          'Eilenberg&ndash;MacLane&rsquo;s classical polynomial functors (\\(\\operatorname{cr}_{n+1} = 0\\)) &mdash; ' +
          'this is exactly the classical setting the calculator in <em>Derivatives &amp; Layers</em> &sect;2 illustrates;</li>' +
